...
$req=$bdd->prepare('SELECT * FROM voiture where marque=?  and categorie=? and couleur=? and moteur=? and boite=?');
$req ->execute(array(@$marque,@$categorie,@$couleur,@$moteur,@$boite));
...
<div class="siege" style="display: inline-flex;"><img src="images/siege.png" height="35" width="35"><p style="margin-left: 18px"><?php echo $données['nbrSiege']?> Siégess </p></div>
